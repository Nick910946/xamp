    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
            ...
            <hr class="sidebar-divider d-none d-md-block">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="reg_emp.php">
                    <i class="fa fa-user-plus text-info"></i>
                    <span class="sidebarfont">Register Employee</span></a>
            </li>
              ...
              <li class="nav-item active">
                <a class="nav-link" href="emp_task.php">
                   <i class="fa fa-tasks text-info"></i>
                    <span class="sidebarfont">Task</span></a>
            </li>

             <hr class="sidebar-divider d-none d-md-block">

              <li class="nav-item active">
                <a class="nav-link" href="show_task.php">
                   <i class="fa fa-bullseye text-info"></i>
                    <span class="sidebarfont">Show task</span></a>
            </li>

             <hr class="sidebar-divider d-none d-md-block">

              <li class="nav-item active">
                <a class="nav-link" href="admin_reply.php">
                   <i class="fa fa-reply text-info"></i>
                    <span class="sidebarfont">Admin Reply</span></a>
            </li>

            <hr class="sidebar-divider d-none d-md-block">

              <li class="nav-item active">
                <a class="nav-link" href="assign_leave.php">
                   <i class="fa fa-user-times text-info"></i>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-bell-o text-truncate"></i><i class=""></i>
                                <!-- Counter - Alerts -->
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-comments text-truncate"></i>
                                <!-- Counter - Messages -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 larg"><?php echo $_SESSION['name'] ?>&nbsp;<?php echo $_SESSION['name1']?></span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="emp_logout.php" type="logout"><butto>logout</button>&nbsp;<i class="fa fa-sign-out"></i></a>
