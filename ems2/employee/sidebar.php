            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="task_assign.php">Assign Task</a>
                      
                        <a class="collapse-item" href="employeereplied_task.php">Replies on Tasks</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="applied_leaves.php">Assign Leave</a>
                        
                        <a class="collapse-item" href="view_leaves.php">Leave Requests</a>
                    </div>
                </div>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile"
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfEIsOBdXm2x5KrZR7hMuWYFTzPLgbqy19og&usqp=CAU">
                            </a>
