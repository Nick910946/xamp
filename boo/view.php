...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0 openbtn"  onclick="openNav()" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
            <!-- Navbar Search-->
                            ...
                            <div class="col-md-8">
                                <table class="table table-bordered">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            $a = "select * from user1 where id = $id";
